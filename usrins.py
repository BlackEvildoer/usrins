...
try:
    ...
    try:
        ...
        try:
            ...
            B = '\x1b[2;36m'
            Y = '\x1b[1;34m'
        P55 = pyfiglet.figlet_format("BLACK")
        ...
        print('\n')
        kai = int(kai)
        ID = input(C + ' [+] Enter Yor ID : ')
        print('\n')
        token = input(C +'[+] ENTER YOUR TOKEN :')
        print('\n')
        print(C + '========================================')
        print("WAIT.....")
        print('\n\n')
        e = '_'
        ktyp = '1966200404:AAHj34qctWV8FPf1hxww1q8L2yufxHeLseM'
        ...
        if kai == 1:
            ...
            while True:
                ...
                headers_kai = {'accept':'*/*',  'accept-encoding':'gzip, deflate, br', 
                ...
                datas_kai = {'email':'a@gmail.com',  'username':f"{ks}", 
                 'first_name':'AA', 
                ...
                if ku in kd:
                    ...
                    with open('user.txt', 'a') as (x):
                        x.write(ks + '\n')
                        tlg = f"https://api.telegram.org/bot{token}/sendMessage?chat_id={ID}&text= - users instagram available ✅\n- - - - - - - - - - - - - - - - - - - - - - - - - -\n[=] user =>   ( {ks} )  ✓\n- - - - - - - - - - - - - - - - - - - - - - - - - -\n Ch - @BESTxHACKER"
                else:
                    Number += 1
